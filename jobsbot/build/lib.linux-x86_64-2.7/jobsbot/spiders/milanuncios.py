...
class MilanunciosFuengirolaSpider(scrapy.Spider):
    name = "milanuncios"
    ...
    def parse(self, response):
        for oferta in response.xpath('//div[@class="aditem"]'):
            ...
            if 'fuengirola' in oferta_title[0].lower():
	            url = oferta_url[0]
    ...
    def parse_oferta(self, response):
        ...
        item['city'] = 'fuengirola'
        yield item

class MilanunciosMalagaSpider(scrapy.Spider):
    name = "milanuncios"
    allowed_domains = ["milanuncios.com"]
    start_urls = ['http://www.milanuncios.com/ofertas-de-empleo-en-malaga/?dias=1&demanda=n']
...
class MilanunciosAndaluciaSpider(scrapy.Spider):
    name = "milanuncios"
    allowed_domains = ["milanuncios.com"]
    start_urls = ['http://www.milanuncios.com/ofertas-de-empleo-en-andalucia/?dias=1&demanda=n']
